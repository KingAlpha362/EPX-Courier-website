        ...
        {loopTestimonials.map(({ text, highlight, image, name, role }, index) => (
          ...
          >
            <div>
              ...
              <p className="text-sm leading-relaxed text-gray-700 font-inter italic">
                {highlight
            ...
            <div className="flex items-center gap-3 mt-4">
              <div className="h-10 w-10 rounded-full bg-primary-dark text-white flex items-center justify-center font-bold text-xs uppercase tracking-tighter shadow-inner">
                {name.split(' ').map(n => n[0]).join('')}
              </div>
              <div className="flex flex-col">
                <div className="font-bold text-xs text-primary-dark uppercase tracking-wider">{name}</div>
                <div className="text-[10px] text-gray-400 font-medium uppercase tracking-widest flex items-center gap-1">
