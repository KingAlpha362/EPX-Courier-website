    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center px-6 md:px-8 pt-24 pb-20 md:pt-28 md:pb-36 relative z-20">
        <div className="flex flex-col items-center max-w-4xl">
          ...
          <h1
            className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-8 md:mb-6 leading-[0.95] tracking-[-0.02em] text-center"
          >
            Think Big.
            <br />
          ...
          <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-4 mb-8 justify-center items-center">
          ...
          <p className="font-inter text-sm text-white/70 max-w-[480px] leading-relaxed text-center">
